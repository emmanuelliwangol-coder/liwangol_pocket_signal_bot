...
def main():
    global telegram_bot
    # Build with JobQueue enabled by default
    ...
    # Add the scanner to the built-in JobQueue
    ...
    log.info(f"🤖 Bot is online with JobQueue! Scanning every {SCAN_EVERY} minutes.")
